...
if os.getenv('WEBSITE_HOSTNAME'):  # Azure Production
    ...
    # Azure-kompatible Session-Konfiguration (temporär deaktiviert)
    app.config['SESSION_TYPE'] = 'null'  # Deaktiviere Session-Filesystem für Azure
