...
def dashboard():
    try:
        ...
        # Urlaubsdaten laden (für beide Endpoints)
        ...
        if request.headers.get('Accept') == 'application/json':
            ...
            return jsonify({
                ...
                'dashboard_data': {
                    ...
                    'pending_count': 0,
                    'resturlaub': tage_uebrig if tage_uebrig is not None else 30,
                    'tage_verbraucht': tage_verbraucht if tage_verbraucht is not None else 0,
                    'tage_verplant': tage_verplant if tage_verplant is not None else 0,
                    'tage_uebrig': tage_uebrig if tage_uebrig is not None else 30,
